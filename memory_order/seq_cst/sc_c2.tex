...
% Column 2
\node (c) at (2.6, -3.5) [draw, rectangle, inner sep=4pt, font=\large] {\texttt{c:~y=4}};
\node (d) at (2.6, -4.2) [draw, rectangle, inner sep=4pt, font=\large] {\texttt{d:~x:3}};

% Column 3
\node (e) at (4.2, -1.5) [draw, rectangle, inner sep=4pt, font=\large] {\texttt{e:~x=3}};
\node (f) at (4.2, -2.25) [draw, rectangle, inner sep=4pt, font=\large] {\texttt{f:~y:2}};
